        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-28 sm:px-6 lg:px-8">
          ...
          <div className="py-8">
            ...
            <section className="mt-6 grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
              ...
              <div className="glass rounded-3xl p-6">
                ...
                <div className="mt-2 flex items-end justify-between gap-4">
                  ...
                  <span className={up ? "rounded-full bg-emerald-400/15 px-3 py-1 text-sm font-black text-emerald-700 dark:text-emerald-200" : "rounded-full bg-rose-400/15 px-3 py-1 text-sm font-black text-rose-600 dark:text-rose-200"}>
                    {stock.change}
                  </span>
                </div>
                <div className="mt-6">
            ...
            <section className="mt-5 grid gap-5 lg:grid-cols-3">
              <InfoCard title="AI 브리핑" text={`${stock.name}은 주말 커뮤니티 관심도가 높은 종목입니다. ${up ? "단기 투자심리는 우호적이지만 과열 구간에서는 분할 접근이 필요해요." : "가격 변동성이 커진 만큼 월요일 장 초반 수급을 확인하는 전략이 좋아 보여요."}`} />
